...
const projects = [
  ...
  { number: "06", title: "On going project", type: "Patient Scheduler System · September 2026", description: "A collection of pixel art pieces created using various digital tools and techniques, showcasing a range of styles and themes.", stack: ["PHP", "Laravel", "React", "MySQL", "Docker"], url: "https://github.com/coochill/pixel-art-collection", accent: "#e2d962" },
];
